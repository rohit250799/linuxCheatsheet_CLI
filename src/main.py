...
from load_from_yaml import display_all_command_categories_num, display_all_command_num, display_all_available_commands_in_cheatsheet
...
parser_commands.add_argument("-a", "--all", help="Display all the arguments in the cheatsheet", dest='allCommands')
